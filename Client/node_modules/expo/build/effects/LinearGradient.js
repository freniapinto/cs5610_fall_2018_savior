...
export default class LinearGradient extends React.Component {
    render() {
        ...
        return (<NativeLinearGradient {...props} colors={colors.map(processColor)} locations={locations} startPoint={start ? _normalizePoint(start) : null} endPoint={end ? _normalizePoint(end) : null}/>);
    }
}
