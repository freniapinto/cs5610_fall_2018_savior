...
let _enabled = true;
const _DISABLED_ERROR = new Error('Cannot complete operation because audio is not enabled.');
...
export function _isAudioEnabled() {
    return _enabled;
}
export function _throwIfAudioIsDisabled() {
    if (!_enabled) {
